...
const readFileContent = async (file: File): Promise<string> => {
  ...
  if (
    ...
    errorMessage =
      "Failed to parse PDF file. Please try uploading a text-based PDF or DOCX.";
  } else if (
    file.type ===
    ...
    errorMessage =
      "Failed to parse DOCX file. Please try uploading a different DOCX file.";
  } else {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      if (response.status === 422) {
        throw new Error(
          "Looks like your file is image-based. Please upload a text-based PDF or DOCX export.",
        );
      }
    ...
    if (error.message.includes("PDF parsing library error")) {
      throw new Error(
        "PDF parsing is currently having issues. Please try uploading a DOCX file instead.",
      );
    }
  ...
  const onDrop = useCallback(
    async (acceptedFiles: File[]) => {
      ...
      try {
        ...
        console.log(
          "Content being sent to AI (first 500 chars):",
          content.substring(0, 500),
        );
        const parsed = await ResumeAI.parseResume(
          content,
        ...
        const enhanced = await ResumeAI.enhanceResume(
          parsed as any,
          "Investment Banking Analyst",
        );
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-finance-600">
            Your resume has been analyzed and enhanced by our AI. You can now
        ...
        <div className="card p-8 mb-8">
          {!uploadedFile ? (
            ...
            >
              ...
              <p className="text-finance-600 mb-4">or click to browse files</p>
            ...
            <div className="text-center">
              ...
              <p className="text-finance-600 mb-4">{uploadedFile.name}</p>
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-finance-800">
                    Content Extraction
                  </h4>
                  <p className="text-sm text-finance-600">
                    Our AI analyzes your resume and extracts key information
                    like experience, education, and skills.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-finance-600">
                    Each bullet point gets enhanced with finance-specific
                    language, quantification, and action verbs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-finance-600">
                    Content is automatically mapped to our locked finance
                    template for consistent, ATS-friendly formatting.
                  </p>
                </div>
              </div>
